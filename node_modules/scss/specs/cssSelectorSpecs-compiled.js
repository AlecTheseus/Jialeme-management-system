...
var _vows$describe$addBat;

var vows = require('vows'),
    assert = require('assert'),
    selectorGrammar = require(__dirname + '/grammarInvoker');

var shouldParse = function shouldParse() {
  var selector,
      context = {
...
var shouldParseTo = function shouldParseTo(expectedSelector) {
  var context = {
    topic: function topic() {
...
vows.describe('Nth Selectors').addBatch((_vows$describe$addBat = {
  ':nth-child(-n)': shouldParse(),
  ':nth-child(+n)': shouldParse(),
  ...
  ':nth-child(-2n+3)': shouldParse(),
  ':nth-child(-2n+ 3)': shouldParse()
}, _defineProperty(_vows$describe$addBat, ':nth-child(-2n+ 3)', shouldParse()), _defineProperty(_vows$describe$addBat, ':nth-child(-2n+ 3)', shouldParse()), _defineProperty(_vows$describe$addBat, ':nth-child( 2n + 3 )', shouldParseTo(':nth-child(2n + 3)')), _vows$describe$addBat)).run();
...
//# sourceMappingURL=cssSelectorSpecs-compiled.js.map