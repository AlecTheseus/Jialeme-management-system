...
QUnit.test('cookie-value with double quotes', function (assert) {
	assert.expect(1);
	using(assert).setCookie('c', '"').then(function (decodedValue) {
...
QUnit.test('cookie-value with double quotes in the left', function (assert) {
	assert.expect(1);
	using(assert).setCookie('c', '"content').then(function (decodedValue) {
...
QUnit.test('RFC 6265 - character not allowed in the cookie-value " "', function (assert) {
	assert.expect(2);
	using(assert).setCookie('c', ' ').then(function (decodedValue, plainValue) {
...
QUnit.test('cookie-value - 2 bytes character (ã)', function (assert) {
	assert.expect(2);
	using(assert).setCookie('c', 'ã').then(function (decodedValue, plainValue) {
...
QUnit.test('cookie-value - 4 bytes character (𩸽)', function (assert) {
	assert.expect(2);
	using(assert).setCookie('c', '𩸽').then(function (decodedValue, plainValue) {
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name "("', function (assert) {
	assert.expect(2);
	using(assert).setCookie('(', 'v').then(function (decodedValue, plainValue) {
...
QUnit.test('cookie-name - 2 bytes characters', function (assert) {
	assert.expect(2);
	using(assert).setCookie('ã', 'v').then(function (decodedValue, plainValue) {
...
QUnit.test('cookie-name - 4 bytes characters', function (assert) {
	assert.expect(2);
	using(assert).setCookie('𩸽', 'v').then(function (decodedValue, plainValue) {
