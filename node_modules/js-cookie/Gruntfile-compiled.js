...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		qunit: {
			all: {
				options: {
					urls: ['http://127.0.0.1:9998/', 'http://127.0.0.1:9998/amd.html', 'http://127.0.0.1:9998/environment-with-amd-and-umd.html', 'http://127.0.0.1:9998/encoding.html?integration_baseurl=http://127.0.0.1:9998/']
				}
			}
		},
		nodeunit: {
		...
		connect: {
			'build-qunit': {
				options: {
					port: 9998,
					base: ['.', 'test'],
					middleware: function middleware(connect, options, middlewares) {
