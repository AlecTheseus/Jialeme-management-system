...
var Module = function Module(rawModule, runtime) {
  ...
  this._children = _Object$create(null);
...
_Object$defineProperties(Module.prototype, prototypeAccessors$1);
...
var Store = function Store(options) {
  ...
  assert(typeof _Promise !== 'undefined', "vuex requires a Promise polyfill in this browser.");
...
_Object$defineProperties(Store.prototype, prototypeAccessors);

function resetStore(store, hot) {
  store._actions = _Object$create(null);
  store._mutations = _Object$create(null);
  store._wrappedGetters = _Object$create(null);
  store._modulesNamespaceMap = _Object$create(null);
...
function resetStoreVM(store, state, hot) {
  ...
  forEachValue(wrappedGetters, function (fn, key) {
    ...
    _Object$defineProperty(store.getters, key, {
      get: function get() {
...
//# sourceMappingURL=vuex.esm-compiled.js.map