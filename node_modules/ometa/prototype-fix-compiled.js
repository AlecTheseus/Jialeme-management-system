...
Ajax.Request.prototype.request = function (url) {
  ...
  if (params = Hash.toQueryString(params)) {
    if (this.method == 'get') this.url += (this.url.include('?') ? '&' : '?') + params;else if (/Konqueror|Safari|KHTML/.test(navigator.userAgent)) params += '&_=';
  }
...
//# sourceMappingURL=prototype-fix-compiled.js.map