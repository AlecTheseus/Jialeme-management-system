...
function doIt() {
  var result = evalSelection();
  if (result) result.source.editor.focus();
}
...
function evalSelection() {
  ...
  try {
    ...
    if (e.errorPos != undefined) {
      ...
      errorMsg = " Parse error ->", oldScrollTop = $('workspaceForm').source.scrollTop;
      $('workspaceForm').source.value = $('workspaceForm').source.value.substring(0, errorPos) + errorMsg + $('workspaceForm').source.value.substring(errorPos, $('workspaceForm').source.value.length);
...
//# sourceMappingURL=workspace-compiled.js.map